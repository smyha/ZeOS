...
struct task_struct {
  ...
  struct task_struct *main_thread; /* Pointer to the main thread of the process */
  struct list_head children; /* List of children processes */
  struct list_head sibling;  /* List of sibling threads */
  struct list_head my_threads; /* List of threads created by this thread */
  void *(*thread_func)(void*); /* Function to execute in the thread */
  void *thread_param;    /* Parameter for the thread function */
};
